...
const experiences = [
  ...
  },
  {
    ...
    description: ['Add support for ethereum and solana to wallet extension'],
  },
  {
    id: 'udaan',
  ...
  },
  {
    ...
    description: ['Develop Gitlab integration to Jenkins'],
  },
];
      ...
      >
        ...
        <div className={styles.timeline__content}>
          {experiences.map((experience, index) => (
            <div key={experience.id} className={styles.timeline__item}>
              ...
              <div className={styles.timeline__content}>
                <div className={styles.timeline__header}>
                  <h3 className={styles.timeline__jobTitle}>
                    {experience.title}
                  </h3>
                  <span className={styles.timeline__company}>
                    {experience.company}
                  </span>
